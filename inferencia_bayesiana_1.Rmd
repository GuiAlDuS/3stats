...
También es muy importante recalcar que con estas distribuciones podemos calcular rangos de certeza (intervalos de credibilidad). Entre estos valores la evidencia nos indica con cierta probabilidad dónde puede estar el valor del parámetro (salidas de la función *precis()*).
