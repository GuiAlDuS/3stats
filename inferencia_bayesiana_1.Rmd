...
-   Según el enfoque frecuentista: probabilidad es el límite de la proporción de un evento en una serie larga de observaciones/experimentos.
...
Usamos la distribución normal como ejemplo de cómo generar un valor desde un modelo generador de datos.
...
En estadística inferencial, normalmente estimamos los valores de los coeficientes de las variables ($b_1$ y $b_2$). Ya que nosotros mismos generamos los datos y conocemos los valores reales de estos coeficientes, podremos comparar qué tanto se acercan los valores de las estimaciones a los valores reales.
...
Viendo el resumen de la regresión podemos notar que los coeficientes se acercan a nuestros valores reales.
